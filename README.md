...
* Please download "depth_imgs.npy" file from the [AVD_Minimal](https://storage.googleapis.com/active-vision-dataset/AVD_Minimal.zip) and put the file locally. 
...
### Testing
* To evaluate our model, please run python3 evaluate.py or evaluete_with_stop.py
