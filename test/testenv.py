...
with open ('./testimagelist', 'rb') as ft:
...
class ActiveVisionDatasetEnv():
    ...
    cached_data=None
    def __init__(self,world,goal_image_id=None, dataset_root='../train/jsonfile/', actions=ACTIONS):
        ...
        self.pos=read_all_poses(dataset_root,self._cur_world)
        self.reset()
